...
if __name__ == '__main__':
    ...
    parser.add_argument('--i', type=int, default=1, help='origin col num?')
    parser.add_argument('--j', type=int, default=2, help='origin row num?')
    parser.add_argument('--x', type=int, default=11, help='dest col num?')
    parser.add_argument('--y', type=int, default=10, help='dest row num?')
